...
static void
update_obj(aoi_space *space, uint32_t id)
{
    int i;
    for (i = 0; i < 3; i++)
    {
    ...
    space->update(id, OBJ[id].mode, OBJ[id].pos);
}
...
int main()
{
    ...
    aoi_space *space = new aoi_space(&cookie, my_alloc);
